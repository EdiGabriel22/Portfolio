<template>
	...
	>
		...
		>
			<div
				class="text-base font-medium leading-relaxed tracking-[0.04em] md:text-lg"
			>
			...
			<h1
				class="text-4xl font-semibold leading-[1.05] tracking-[0.03em] md:text-[64px] lg:text-[96px]"
			>
				Product designer
				<br />
				& Front-End Developer
